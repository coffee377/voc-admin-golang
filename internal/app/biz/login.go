...
type ILogin interface {
	...
	// 登录验证
	Verify(ctx context.Context, userName, password string) (*model.User, error)
	// 生成令牌
	...
	// 查询用户的权限菜单树
	//QueryUserMenuTree(ctx context.Context, userID string) ([]*interface{}, error)
	// 更新用户登录密码
	//UpdatePassword(ctx context.Context, userID string, params interface{}) error
}
